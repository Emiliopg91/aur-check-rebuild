...
package() {
  ...
  install -Dm755 "scripts/aur-check-rebuild/aur-check-rebuild.py" "$pkgdir/usr/share/libalpm/scripts/aur-check-rebuild/main.py"
  install -Dm755 "scripts/aur-check-rebuild/helpers/libalpm.py" "$pkgdir/usr/share/libalpm/scripts/aur-check-rebuild/helpers/libalpm.py"
  install -Dm755 "scripts/aur-check-rebuild/helpers/settings.py" "$pkgdir/usr/share/libalpm/scripts/aur-check-rebuild/helpers/settings.py"
